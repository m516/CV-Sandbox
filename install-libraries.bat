...
vcpkg install opencv4:x64-windows opencv4:x86-windows glad:x64-windows glad:x86-windows glew:x64-windows glew:x86-windows cuda:x86-windows cuda:x64-windows
IF ERRORLEVEL 1 (
